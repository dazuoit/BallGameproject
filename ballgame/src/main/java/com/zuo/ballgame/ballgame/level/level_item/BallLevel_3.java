 ...
 * @version: 版本号
 */
public class BallLevel_3 implements BaseLevel {
	int level;

	public BallLevel_3(int level) {
		this.level = level;
	}
	...
	public int[] level_balls() {
		return new int[]{
				...
				1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 3, 2, 2, 4, 4, 4,
				1, 5, 5, 4, 1, 1, 3, 3, 3, 3, 1, 5, 4, 4, 1, 6, 0, 0, 0, 0,
				1, 5, 1, 6, 1, 1, 1, 3, 3, 4, 4, 4, 4, 3, 3, 5, 4, 4, 4, 4,
				0, 0, 0, 1, 1, 1, 5, 4, 3, 0, 5, 5, 5, 2, 2, 2, 4, 4, 4, 4
		};
	...
	public int[][] levelBind() {
		return new int[][]{
				{
						0, 1, 20, 21, 22, 23, 24, 25, 26, 40, 44, 45, 60, 62, 64, 65, 66, 83, 85
				},

				{
						46, 47, 48, 49, 67, 68, 88
				},
				{
						21, 22, 41, 42, 69, 70, 71, 71
				}
		};
	}
