 ...
 * @version: 版本号
 */
public class BallLevel_1 implements BaseLevel {
	int level;

	public BallLevel_1(int level) {
		this.level = level;
	}
	...
	public int[] level_balls() {
		return new int[]{
				...
				1, 5, 1, 6, 1, 1, 1, 3, 3, 3, 3, 3, 3, 3, 3, 5, 4, 4, 4, 4,
	...
	public int[][] levelBind() {
		return new int[][]{
				...
				{
						46, 47, 48, 49, 67, 68, 69, 70, 71, 72, 73, 74, 88, 89
				}
		};
	}
