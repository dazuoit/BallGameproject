 ...
 * @version: 版本号
 */
public class BallLevel_12 implements BaseLevel {
	int level;

	public BallLevel_12(int level) {
		this.level = level;
	}
	...
	public int[] level_balls() {
		return new int[]{
				...
				1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 5, 5, 3, 2, 2, 4, 4, 4,
				1, 5, 5, 4, 1, 1, 3, 3, 3, 3, 1, 5, 5, 5, 1, 6, 0, 0, 0, 0,
				1, 5, 1, 6, 1, 1, 1, 3, 3, 3, 3, 3, 5, 5, 4, 4, 4, 4, 4, 4,
				0, 0, 0, 1, 1, 1, 5, 4, 3, 3, 5, 0, 5, 0, 2, 0, 4, 4, 4, 4
		};
