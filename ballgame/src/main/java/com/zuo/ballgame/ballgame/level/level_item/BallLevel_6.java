 ...
 * @version: 版本号
 */
public class BallLevel_6 implements BaseLevel {
	int level;

	public BallLevel_6(int level) {
		this.level = level;
	}
	...
	public int[] level_balls() {
		return new int[]{
				...
				1, 5, 5, 4, 4, 4, 3, 3, 3, 3, 1, 5, 1, 6, 1, 6, 0, 0, 0, 0,
				1, 5, 1, 6, 1, 1, 1, 1, 3, 3, 3, 3, 3, 3, 3, 5, 5, 5, 4, 4,
