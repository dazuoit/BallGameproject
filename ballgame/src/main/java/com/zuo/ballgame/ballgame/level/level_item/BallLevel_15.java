 ...
 * @version: 版本号
 */
public class BallLevel_15 implements BaseLevel {
	int level;

	public BallLevel_15(int level) {
		this.level = level;
	}
	...
	public int[] level_balls() {
		return new int[]{
				...
				1, 5, 5, 4, 1, 1, 3, 3, 3, 3, 1, 5, 1, 6, 2, 2, 0, 0, 0, 0,
				1, 5, 1, 6, 1, 1, 1, 3, 3, 3, 3, 3, 3, 3, 2, 2, 4, 4, 4, 4,
				0, 0, 0, 1, 1, 1, 5, 4, 3, 3, 5, 5, 5, 0, 2, 0, 4, 0, 4, 4
		};
	...
	public int[][] levelBind() {
		return new int[][]{
				...
				{
						35, 36, 54, 55, 74, 75, 94
				},
				{
						76, 77, 78, 79, 96, 98, 99
				}
		};
	}
